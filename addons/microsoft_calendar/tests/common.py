...
class TestCommon(HttpCase):
    ...
    def setUp(self):
        ...
        self.simple_event_ms_values = {
            ...
            "organizer": {
                'emailAddress': {
                    'address': self.organizer_user.login,
            ...
            "attendees": [
                {
                    'emailAddress': {
                        'address': self.attendee_user.login,
        ...
        self.simple_event_from_outlook_organizer = {
            ...
            'attendees': [{
                ...
                'emailAddress': {'name': self.attendee_user.display_name, 'address': self.attendee_user.login}
            }],
            'isAllDay': False,
            'isCancelled': False,
            'sensitivity': 'normal',
            ...
            'location': {'displayName': ''},
            'organizer': {
                'emailAddress': {'address': self.organizer_user.login, 'name': self.organizer_user.display_name},
            },
        ...
        self.recurrent_event_from_outlook_organizer = [{
            'attendees': [{
                'emailAddress': {'address': self.attendee_user.login, 'name': self.attendee_user.display_name},
                'status': {'response': 'none', 'time': '0001-01-01T00:00:00Z'},
                'type': 'required'
            }],
            'body': {
            ...
            'organizer': {'emailAddress': {
                'address': self.organizer_user.login, 'name': self.organizer_user.display_name}
            },
            'recurrence': {
                'pattern': {
                    'dayOfMonth': 0,
