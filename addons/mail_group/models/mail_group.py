...
class MailGroup(models.Model):
    ...
    def _check_moderator_email(self):
        if any(not moderator.login for group in self for moderator in group.moderator_ids):
    ...
    def _notify_members(self, message):
        ...
        member_emails = {
            email_normalize(member.login): member.login
    ...
    def action_join(self):
        ...
        self.sudo()._join_group(partner.login, partner.id)
    ...
    def action_leave(self):
        ...
        self.check_access_rule('read')
        partner = self.env.user.partner_id
        self.sudo()._leave_group(partner.login, partner.id)
