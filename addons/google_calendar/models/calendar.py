...
class Meeting(models.Model):
    ...
    def _odoo_attendee_commands(self, google_event):
        ...
        attendees_by_emails = {tools.email_normalize(a.login): a for a in existing_attendees}
        ...
        for odoo_attendee in attendees_by_emails.values():
            ...
            email = tools.email_normalize(odoo_attendee.login)
            if email not in emails and email != self.env.user.login:
    ...
    def _google_values(self):
        ...
        values = {
            ...
            'organizer': {'email': self.user_id.login, 'self': self.user_id == self.env.user},
