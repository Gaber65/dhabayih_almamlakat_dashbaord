...
class WebsiteVisitor(models.Model):
    ...
    def _compute_email_phone(self):
        ...
        for visitor in self.filtered(lambda visitor: not visitor.login or not visitor.mobile):
            ...
            if not visitor.login:
                visitor.login = next((reg.login for reg in linked_registrations if reg.login), False)
