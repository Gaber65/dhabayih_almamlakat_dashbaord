...
class TestUi(HttpCaseWithUserDemo, HttpCaseWithUserPortal):
    ...
    def test_website_event_questions(self):
        ...
        first_registration = registrations.filtered(lambda reg: reg.login == 'attendee-a@gmail.com')
        second_registration = registrations.filtered(lambda reg: reg.login == 'attendee-b@gmail.com')
