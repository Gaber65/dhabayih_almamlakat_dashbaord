...
class TestResetPassword(HttpCase):
    ...
    def test_reset_password(self):
        ...
        self.assertEqual(self.test_user.login, url_parse(self.test_user.with_context(create_user=True).signup_url).decode_query()["signup_email"], "query must contain 'signup_email'")
