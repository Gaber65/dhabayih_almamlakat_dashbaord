...
class WebsiteVisitor(models.Model):
    ...
    def _compute_email_phone(self):
        ...
        left_visitors = self.filtered(lambda visitor: not visitor.login or not visitor.mobile)
        ...
        for visitor in left_visitors:
            ...
            if not visitor.login:
                visitor.login = next((lead.email_normalized for lead in visitor_leads if lead.email_normalized), False)
