...
class TestCRMLead(TestCrmCommon):
    ...
    def test_crm_lead_creation_partner(self):
        ...
        self.assertEqual(lead.partner_name, self.contact_company_1.name)
        self.assertEqual(lead.contact_name, self.contact_1.name)
        self.assertEqual(lead.email_from, self.contact_1.login)
    ...
    def test_crm_lead_partner_sync(self):
        ...
        partner_email, partner_phone = self.contact_2.login, self.contact_2.phone
        ...
        self.assertEqual(partner.login, '"John Zoidberg" <john.zoidberg@test.example.com>')
        ...
        self.assertFalse(partner.login)
    ...
    def test_crm_lead_partner_sync_email_phone(self):
        ...
        with self.debug_mode():
            ...
            self.assertEqual(partner.login, partner_email)
            ...
            lead_form.save()
            self.assertEqual(partner.login, new_email)
    ...
    def test_crm_lead_update_contact(self):
        ...
        self.assertEqual(lead.email_from, self.contact_company_1.login)
        self.assertEqual(lead.phone, self.test_phone)
        self.assertEqual(lead.email_state, 'correct')
        ...
        self.assertEqual(self.contact_company_1.login, 'broken')
    ...
    def test_mailgateway(self):
        ...
        self.assertEqual(new_lead.partner_id.login, 'unknown.sender@test.example.com')
