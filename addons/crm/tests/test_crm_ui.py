...
class TestUi(HttpCase):
    ...
    def test_email_and_phone_propagation_edit_save(self):
        ...
        self.assertEqual(partner.login, 'test@example.com', 'Should have propagated the lead email on the partner')
    ...
    def test_email_and_phone_propagation_remove_email_and_phone(self):
        ...
        # Check initial state
        self.assertEqual(partner.login, 'test@example.com')
        self.assertEqual(lead.phone, '+32 494 44 44 44')
        self.assertEqual(lead.email_from, 'test@example.com')
        self.assertEqual(lead.phone, '+32 494 44 44 44')
        ...
        self.assertFalse(partner.login, 'Should have removed the email')
