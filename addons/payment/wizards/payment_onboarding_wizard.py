...
class PaymentWizard(models.TransientModel):
    ...
    def _get_default_payment_provider_onboarding_value(self, key):
        ...
        if 'payment_paypal' in installed_modules:
            ...
            self._payment_provider_onboarding_cache['paypal_email_account'] = provider['paypal_email_account'] or self.env.company.login
            self._payment_provider_onboarding_cache['paypal_pdt_token'] = provider['paypal_pdt_token']
        else:
            self._payment_provider_onboarding_cache['paypal_email_account'] = self.env.company.login
