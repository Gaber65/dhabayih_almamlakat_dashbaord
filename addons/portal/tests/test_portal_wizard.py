...
class TestPortalWizard(MailCommon):
    ...
    def test_portal_wizard_acl(self):
        ...
        with self.assertRaises(AccessError, msg='Standard users should not be able to open the portal wizard'):
            portal_wizard.user_ids.with_user(self.user_employee).login
    ...
    def test_portal_wizard_partner(self):
        ...
        portal_user.login = 'first_email@example.com'
        ...
        self.assertEqual(self.partner.login, 'first_email@example.com', 'Must write on the email of the partner')
        self.assertEqual(new_user.login, 'first_email@example.com', 'Must create the user with the right email')
    ...
    def test_portal_wizard_public_user(self):
        ...
        portal_user.login = 'new_email@example.com'
        with self.mock_mail_gateway():
            portal_user.action_grant_access()
        ...
        self.assertEqual(public_partner.login, 'new_email@example.com', 'Must change the email of the partner')
        self.assertEqual(self.public_user.login, 'new_email@example.com', 'Must change the email of the user')
    ...
    def test_portal_wizard_error(self):
        ...
        portal_user.login = 'test_error@example.com'
        ...
        portal_user.login = 'wrong email format'
